...
BasicGame.glassLevel.prototype = {
   ...
   returnToMenu: function (pointer) {
    ...
    usePowder: function () {
        ...
        response.setText("A brush and black powder is ideal for processing a clear, nonporous piece of evidence at the scene.  Using the powder, you reveal a fingerprint!  You photograph and collect the print using a tape lift.  All items are packaged correctly.  Click Next and return to the crime scene to process more evidence.");
    },
    ...
    collectItem: function () {   
      ...
      response.setText("You could collect this item, but this glass is a nonporous item that is clear.  Try something else before you lug it back to the crime lab.");
    },
